...
const Product = () => {
  return (
    <div className="ProductSection flex flex-col justify-center items-center">
      <div className="flex flex-col justify-center items-center gap-[3rem] w-[100%] px-[3rem]  "> 

        <div className='flex flex-col md:flex-row gap-10 '>
             <AllProduct des={section1.des} photo={section1.photo}/>
             <AllProduct des={section2.des} photo={section2.photo}/>
        ...
        <div className='bg-yellow-500 md:h-[15rem] h-[25rem] px-[2rem] border rounded-xl '>
            <div className='flex flex-col md:flex-row items-center md:items-start justify-between p-[3rem]'>
